...
@section('content')
    ...
    <div class="candidates" id="kilalanin">
        ...
        <div class="candidate w-224 "><a href="#"><img src="{{ asset('assets/images/candidates/first/dumagan.png') }}" alt="" title=""></a></div>
        <div class="candidate w-224 "><a href="#"><img src="{{ asset('assets/images/candidates/first/layno.png') }}" alt="" title=""></a></div>
        <div class="candidate w-224 "><a href="#"><img src="{{ asset('assets/images/candidates/first/momo.png') }}" alt="" title=""></a></div>
        <div class="candidate w-224  "><a href="#"><img src="{{ asset('assets/images/candidates/first/montesclaros.png') }}" alt="" title=""></a></div>
        <div class="clear"></div>
    </div>
    ...
    <div class="candidates" id="kilalanin">
        ...
        <div class="candidate w-224 "><a href="#"><img src="{{ asset('assets/images/candidates/second/cejoco.png') }}" alt="" title=""></a></div>
        <div class="candidate w-224"><a href="#"><img src="{{ asset('assets/images/candidates/second/garay.png') }}" alt="" title=""></a></div>
        <div class="candidate w-224"><a href="#"><img src="{{ asset('assets/images/candidates/second/salazar.png') }}" alt="" title=""></a></div>
        <div class="candidate w-224"><a href="#"><img src="{{ asset('assets/images/candidates/second/sayawan.png') }}" alt="" title=""></a></div>
        <div class="clear"></div>
    </div>
